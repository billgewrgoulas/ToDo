        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                <a class="nav-item nav-link active"
                    ...
                    profile</a>
                <a class="nav-item nav-link active" href="http://localhost:8080/todo/comments/create">Submit</a>
                <a class="nav-item nav-link active" href="http://localhost:8080/todo/comments">History</a>
