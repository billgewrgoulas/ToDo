...
CodeIgniter uses the [Git-Flow](http://nvie.com/comments/a-successful-git-branching-model/) branching model which requires all pull requests to be sent to the "develop" branch. This is
